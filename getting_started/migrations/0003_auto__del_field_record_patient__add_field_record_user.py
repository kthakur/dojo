...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'Record.patient'
        db.delete_column('getting_started_record', 'patient_id')

        # Adding field 'Record.user'
        db.add_column('getting_started_record', 'user',
                      self.gf('django.db.models.fields.related.ForeignKey')(default='2', to=orm['auth.User']),
                      keep_default=False)


    def backwards(self, orm):
        # Adding field 'Record.patient'
        db.add_column('getting_started_record', 'patient',
                      self.gf('django.db.models.fields.related.ForeignKey')(default='2', to=orm['auth.User']),
                      keep_default=False)

        # Deleting field 'Record.user'
        db.delete_column('getting_started_record', 'user_id')
